...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2017 a las 03:09:00
...
INSERT INTO `piso` (`CODPISO`, `CODED`, `CODSALA`) VALUES
('04', '001', 'B404'),
('05', '002', 'A406');
...
INSERT INTO `solicitud` (`CODSOL`, `DIA`, `RAMO`, `PERIODO`, `SEMESTRE`, `RUT`, `CODSALA`, `NOMBRE`) VALUES
(2017, '2', 'arduino 1', 2, '1', '18989161', 'A406', 'Jaime Morales'),
(12017, '3', 'diseño', 4, '1', '17875041', 'B404', 'Marcelo Ibarra');
...
('17875041', '3', '1234', 'marcelo ibarra', 'marceloibarra@gmail.com', 9878787, 'profesor', '05'),
('17875045', '3', '1234', 'alejandra collao', 'alejandracollao@upla.cl', 1001, 'secretaria', '04'),
('17875046', '3', '1234', 'marta ', 'marta@upla.cl', 2002, 'secretaria', '05'),
('18989161', '2', '1234', 'jaime morales', 'jaimemorales@upla.cl', 9001001, 'profesor', '04');
...
ALTER TABLE `piso`
  ...
  ADD CONSTRAINT `FK_PISO_SALA` FOREIGN KEY (`CODSALA`) REFERENCES `sala` (`CODSALA`);
